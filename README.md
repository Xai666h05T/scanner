<p align="center">
	<img src="https://i.ibb.co/26xpfdD/images-11.jpg" width="600px">
</p>
...
# Scans That You Can Perform Using Xai666h05T Scanner :
+ Basic Scan
	- Site Title **NEW**
	- IP Address
...
2. For The Bloggers View To Work Properly you have to configure Xai666h05T Scanner with moz.com's api keys for that follow the following steps:

**How To Configure Xai666h05T Scanner with moz.com for Bloggers View Scan**
...
# Usage:
- git clone `https://github.com/Xai666h05T/scanner`
- cd scanning
- php scan.php
...
Xai666h05T Scanning `CMS Detector` currently is able to detect the following CMSs (Content Management Systems) in case the website is using some other CMS, Detector will return _could not detect_.
