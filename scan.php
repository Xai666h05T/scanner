...
function update()
    {
        echo "\n\e[91m\e[1m[+] Xai666h05T Scanner [+]\nUpdate in progress, please wait...\n\n$cln";
        system("git fetch origin && git reset --hard origin/master && git clean -f -d");
        echo $bold . $fgreen . "[i] Job finished successfully! Please Restart Xai666h05T Scanner \n" . $cln;
        exit;
    }
...
if ($ip == "help")
  {
    echo "\n\n[+] Xai666h05T Scanner Help Screen [+] \n\n";
...
elseif ($ip == "fix")
  {
    echo "\n\e[91m\e[1m[+] Xai666h05T Scanner FiX MENU [+]\n\n$cln";
            ...
            if (strpos($srccd, "wp-content") !== false)
              {
                ...
                if ($wp_version != "")
                  ...
                  {
                    $reallink = $ipsl . $ip;
                    echo $red . "Failed \n\n[!] Xai666h05T Scanner could not determine the WordPress version of the target!";
                    echo "\n\n";
                    echo $bold . $yellow . "[*] Scanning Complete. Press Enter To Continue OR CTRL + C To Stop\n\n";
                    trim(fgets(STDIN, 1024));
                    goto scanlist;
